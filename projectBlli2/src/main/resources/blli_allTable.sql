...
alter table blli_small_product add( product_db_insert_count number(3) default 0)
alter table blli_small_product add( small_Product_Ranking number(4))

ALTER TABLE  blli_small_product  RENAME COLUMN product_db_insert_count TO db_insert_posting_count
